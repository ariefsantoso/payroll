...
<div class="container-fluid pt-4 px-4">
    ...
    <form action="{{ route('pdf') }}" method="POST">
        ...
        <div class="mb-3">
            <input type="submit" value="Eksport PDF" class="btn btn-primary mb-3">
        </div>
    </form>
            ...
            <table class="table text-start align-middle table-bordered table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Rp. {{ number_format($datakaryawan->total_gaji, 0, ',', '.') }}</td>                            
                        
                        <td>
                            <a class="btn btn-sm btn-warning" href="/gaji/{{ $datakaryawan->id }}/edit">Edit</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
