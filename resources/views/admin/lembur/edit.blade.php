...
<div class="container-fluid pt-4 px-4">
    ...
    <form action="{{ route('cuti.update', $cuti->id) }}" method="POST">
        ...
        <div id="form-container">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <select class="form-select" aria-label="Default select example" name="nik" id="nik">
                        <option value="{{ $cuti->nik }}" disabled selected>{{ $cuti->karyawan->nama }}</option>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <select class="form-select" aria-label="Default select example" name="jenis_cuti" id="jenis_cuti">
                        <option value="{{ $cuti->jenis_cuti }}" disabled selected>{{ $cuti->jenis_cuti }}</option>
            ...
            <div class="mb-3 row">
                <label for="tanggal" class="col-sm-2 col-form-label">Tanggal Cuti</label>
                <div class="col-sm-10">
                  <input type="date" class="form-control" name="tanggal" id="tanggal" placeholder="Masukkan Tanggal Masuk" value="{{ $cuti->tanggal }}">
                </div>
            </div>
        </div>
        <br>
