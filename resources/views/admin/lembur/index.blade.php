                ...
                <div class="my-3 col-12 col-sm-8 col-md-5">
                    <form action="" method="get">                    
                        <div class="input-group mb-3">
                            ...
                            <a href="/absensi/lembur/create" class="btn btn-primary m-1">Tambah Data </a>
                        </div>
                    </form>
                </div>
    ...
    @endif
        ...
        <div class="table-responsive">
            <table class="table text-start align-middle table-bordered table-hover mb-0">
                ...
                <tbody>
                    @foreach ($lembur as $datakaryawan)
                    <tr>
                        {{-- <td><input class="form-check-input" type="checkbox"></td> --}}
                        <td>{{ $loop->iteration }}</td>
                        <td>{{ ($datakaryawan->nik) }}</td>
                        <td>{{ ($datakaryawan->karyawan->nama) }}</td>
                        <td>{{ ($datakaryawan->jumlah_jam) }}</td>                            
                        <td>Rp. {{ number_format($datakaryawan->total_upah, 0, ',', '.') }}</td>                            
